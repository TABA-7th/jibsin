import sys
import os
sys.path.append(r"C:\Users\senbo\Desktop\python\rrr\ai_series")
import ledger_s
import coai_s
import test_s_1
...
def start_ledger():
    ...
    output_file_path = r"C:\Users\senbo\Desktop\python\rrr\test_st\ledger_result.json"
...
def start_coai():
    ...
    output_file_path = r"C:\Users\senbo\Desktop\python\rrr\test_st\coai_result_a.json"
    coai_s.request(img_list,output_file_path)

def start_reg():
    img_list = [rf"C:\Users\senbo\Desktop\python\rrr\test\000{i}.jpg" for i in range(1,4)]
    output_file_path = r"C:\Users\senbo\Desktop\python\rrr\test_st\reg_result.json"
    output_file_path_2 = r"C:\Users\senbo\Desktop\python\rrr\test_st\reg_m.jpg"
